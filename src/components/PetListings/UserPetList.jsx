...
const UserPetListing = () => {
  return (
    <section className="mx-14">
      <h2 className="text-2xl font-semibold  my-4">My Pets</h2>

      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3   ">
        {userPets.map((pet) => (
          <Link key={pet.id} to={`/profile/pets/${pet.id}`}>
            <Card className="border border-gray-500 rounded-2xl shadow hover:shadow-lg transition overflow-hidden w-[400px] h-[420px] pt-4">
      ...
      <div className="flex justify-center items-center gap-3 my-6">
        ...
        <div className="flex gap-2 ">
          ...
          <Button className="hover:cursor-pointer bg-gray-200 text-gray-700">2</Button>
